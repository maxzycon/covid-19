...
(function (T, O) {
  ...
  O(n, "Core/Utilities.js", [n["Core/Globals.js"]], function (f) {
    ...
    function y(b, c) {
      return !!b && "object" === _typeof(b) && (!c || !E(b));
    }
  ...
  O(n, "Core/Renderer/SVG/SVGElement.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Utilities.js"]], function (f, a, n) {
    ...
    n = function () {
      ...
      F.prototype.shadow = function (e, c, b) {
        ...
        var x;
        !0 === e ? x = l : "object" === _typeof(e) && (x = m(l, e));
    ...
    a = function () {
      ...
      a.prototype.optionsToObject = function (f) {
        var m = {},
            ...
            d = 0,
            p = 0;
        if (L(f) || null === f) m[k[0]] = f;else if (v(f)) for (!l && f.length > g && (h = _typeof(f[0]), "string" === h ? m.name = f[0] : "number" === h && (m.x = f[0]), d++); p < g;) {
          l && "undefined" === typeof f[d] || (0 < k[p].indexOf(".") ? a.prototype.setNestedProperty(m, f[d], k[p]) : m[k[p]] = f[d]), d++, p++;
        } else "object" === _typeof(f) && (m = f, f.dataLabels && (h._hasPointLabels = !0), f.marker && (h._hasPointMarkers = !0));
        return m;
      };
